...
//add event listeners for the start button && onscreen keyboard buttons:

//Add a click event listener to the "Start Game" button
//which creates a new Game object
...
//USE Event delegation >> to avoid having to add an event listener
//to each individual keyboard button.
//Clicking the space between and around the onscreen keyboard buttons should not result
//in the handleInteraction() method being called.
